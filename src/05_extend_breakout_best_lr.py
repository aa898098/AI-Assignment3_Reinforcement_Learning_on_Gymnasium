...
OUTPUT_DIR = r"D:/YS/assim3/05"
MODEL_DIR = os.path.join(OUTPUT_DIR, "models")
LOG_DIR = os.path.join(OUTPUT_DIR, "logs")
CHECKPOINT_DIR = os.path.join(OUTPUT_DIR, "checkpoints")

PRETRAINED_MODEL_PATH = r"D:/YS/assim3/04/lr_1e-4/models/ppo_breakout_lr_1e-4_final.zip"

CONFIG = {
    "script": "05_extend_breakout_best_lr.py",
    "environment": "ALE/Breakout-v5",
    "algorithm": "PPO",
    "policy": "CnnPolicy",
    "source_model": PRETRAINED_MODEL_PATH,
    "source_training_timesteps": 500_000,
    "additional_timesteps": 1_500_000,
...
def main():
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        name_prefix="ppo_breakout_lr_1e-4_extended",
    ...
    model.learn(
        ...
        tb_log_name="ppo_breakout_lr_1e-4_extended",
    ...
    final_model_path = os.path.join(
        MODEL_DIR,
        "ppo_breakout_lr_1e-4_extended_final"
    )
    ...
    print("Extended training finished successfully.")
